...
export default function Sidebar({ isOpen, onClose }: { isOpen?: boolean, onClose?: () => void }) {
  ...
  return (
    ...
    `}>
      <div className="h-32 flex items-center justify-center border-b border-slate-800 px-6 bg-slate-950">
        <img src="/logo-dark.jpeg" alt="TiendeoPOS" className="h-24 object-contain" />
      </div>
